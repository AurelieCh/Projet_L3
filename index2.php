    ...
    <div style="min-height: 100vh;  background-color: rgba(51, 51, 51, 0.9);">
      ...
      <section class="d-flex" style="height: 90vh; color: aliceblue;">
        <div class="ml-2" style="margin-top: 15rem">
          <h1 class="ml-2">Association Nouveau Regard</h1>
          <p class="lead container-fluid">Bienvenue sur le site internet de l'association Nouveau Regard, <br>ici, vous pouvez en apprendre plus sur nos activités, <br>notre but, ou encore notre emplacement. </p>
        </div>
      </section>
