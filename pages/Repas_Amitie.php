...
<html lang="fr">
  ...
  <body class="d-flex flex-column min-vh-100">
      ...
      <section class="d-flex" style="height: 90vh; color: aliceblue;">
        <div class="ml-2" style="margin-top: 15rem">
          <h1 class="ml-2">Les repas de l'amitié</h1>
          <p class="lead container-fluid">Merci de vous intéresser à nos repas de l'amitié ! <br> <br>Les repas de l'amitié sont des repas que nous organisons régulièrement pour nous retrouver, échanger sur l'association et nous amuser. 
          <br> <br>Vous pouvez nous rejoindre, les informations sur les repas de l'amitié sont données sur notre page facebook disponible <a href="https://www.facebook.com/Association-Nouveau-Regard--258870411437832/" target="_blank"> ici</a></p>
        </div>
      </section>
    ...
    <!-- Scripts necessaire a bootstrap -->
